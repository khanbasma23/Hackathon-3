    ...
    <div className="w-full">
      ...
      <div className="w-full h-[45px] px-4 md:px-12 lg:px-24 bg-[#272343] flex justify-between items-center text-white">
        <div className="flex items-center gap-2 text-sm md:text-base">
          <TiTick className="text-xl" /> Free Shipping On All Orders Over $50
        </div>
      ...
      {/* Footer Section */}
      <div className="bg-[#FFFFFF] w-full py-8 px-4 md:px-12 lg:px-24">
        <div className="flex flex-wrap justify-center items-center gap-8">
          <Image src="/image/Chairy.svg" alt="Footer Logo" width={200} height={100} />
          <Image src="/image/footer-text.svg" alt="Footer Text" width={105} height={50} />
          <Image src="/image/Frametext.svg" alt="Frame Text" width={156} height={80} />
          <Image src="/image/Newsletter.svg" alt="Newsletter" width={250} height={120} className="border border-gray-200 rounded-md" />
        </div>
        <div className="w-full mt-8">
          <Image src="/image/Frame 69.svg" alt="Footer Bottom" width={1320} height={300} />
        </div>
      </div>
    </div>
  );
